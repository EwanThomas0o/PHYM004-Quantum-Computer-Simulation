...
int main(){
    ...
    gsl_spmatrix* real = gsl_spmatrix_alloc(matrix_one->size1, matrix_two->size2);
    gsl_spmatrix* imag = gsl_spmatrix_alloc(matrix_one->size1, matrix_two->size2);
    gsl_spmatrix_complex* answer =  gsl_spmatrix_alloc(matrix_one->size1, matrix_two->size2);
    ...
    gsl_spmatrix_add(real_real, imag_imag, real);
    gsl_spmatrix_add(real_imag, imag_real, imag);
