...
gsl_vector_complex* oracle_gate(gsl_vector_complex* wavefunction, int answer){
    gsl_matrix_complex* oracle = gsl_matrix_complex_alloc(wavefunction->size);
    gsl_matrix_complex_set_identity(oracle);
    gsl_matrix_complex_set(oracle, answer-1, answer-1, gsl_complex_rect(-1,0));
