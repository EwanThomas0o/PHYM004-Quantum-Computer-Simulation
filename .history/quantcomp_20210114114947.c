...
gsl_vector_complex* init_wavefunction_sp(int states){ //Initialising wf to equal probability of all states
    
    gsl_vector_complex* wavefunction = NULL;
    wavefunction = gsl_vector_complex_alloc(states);
    gsl_vector_complex_set_all(gsl_complex_rect(1/sqrt(8,0)));
}
